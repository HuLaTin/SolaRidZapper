...
if (len(sys.argv) - 1) < 4:
  ...
  print("./scriptName windowSize triggerVal lineCount baseFilename.csv")
  print(sys.argv[0] + " 35 -2.9 8000 outFilename.csv")
  print(sys.argv[0] + " 35 -3.1 8000 armyWormMothRun1.csv")
  exit(1)
